...
@section('contenido')
        ...
        <div id="js__scroll-to-section" class="container g-padding-y-80--xs g-padding-y-125--sm">
            <div class="g-text-center--xs g-margin-b-100--xs">
                ...
                <h2 class="g-font-size-32--xs g-font-size-36--md">El Museo de Historia de Quetzaltenango se dedica al estudio, preservación y difusión de la historia del occidente de Guatemala</h2>
                <h2 class="g-font-size-22--xs g-font-size-26--md">presentando varias exhibiciones:  </h2>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 g-margin-t-15--xs g-margin-b-60--xs g-margin-b-0--lg">
                        ...
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Acerca del</h2>
                        </div>
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md">Ferrocarril de los Altos</h2>
                        </div>
                    </div>
