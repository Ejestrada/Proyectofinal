          ...
          <tbody>
            @foreach ($rangos as $rango)
              <tr>
                ...
                <td>
                  <a class="tooltipped  btn-floating btn-small waves-effect waves-light light-blue darken-4" data-position="bottom"  href="{{route('rangos.edit',$rango->id,$rango->nombre)}}" data-delay="50" data-tooltip="Editar tipo"><i class="material-icons">edit</i></a>
